...
/**
* Main method presents a user
* with a menu containing eight options.
   ...
   //double label, a, b, c;   
      ...
      do {
         ...
         switch (codeChar) {
            ...
            case 'R': //Reads input file which creates EllipsoidList object
